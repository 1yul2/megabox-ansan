  ...
  return (
    <div className="flex justify-center pb-16 px-2 sm:px-4">
      <div className="w-full max-w-2xl">
        {/* ── 헤더 ── */}
        <div className="bg-gradient-to-br from-[#1a0f3c] to-[#351f66] text-white rounded-2xl shadow-xl overflow-hidden mb-1">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 mt-3">
          ...
          <div className="mt-2 divide-y divide-gray-50">
            ...
            {hasHoliday && (
              <Row label="공휴일수당 (1.5배)" value={fmt(data.holiday_pay)} />
            )}
            {hasLaborDay && (
              <Row label="근로자의날수당 (1.5배)" value={fmt(data.labor_day_pay)} />
            )}
        ...
        {/* ── 실수령액 ── */}
        <div className="bg-gradient-to-r from-emerald-600 to-teal-600 rounded-2xl shadow-lg p-6 mt-3 text-white">
